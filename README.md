...
- **ยังไม่เคยยิงสลิปที่ถ่ายจากมือถือจริง** — ทั้งเส้นทางผ่านหมดแล้วกับสลิปที่วาดขึ้นมา (ตัวอักษรคม ไม่เอียง ไม่มีเงา) รูปถ่ายจริงยากกว่านั้น ถ้า Vision อ่านพลาดจะไปโผล่ที่ `slip_parser` ไม่ใช่ที่ Vision — ดู `scripts/check_ai.py --slip PATH`
