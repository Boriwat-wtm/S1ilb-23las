...
**เลือกโมเดลยังไง** — งานนี้คือจำแนกชื่อร้านสั้นๆ เข้า ~10 หมวดที่ต่างกันชัด ซึ่งอยู่ใกล้เพดานของโมเดลทุกตัวอยู่แล้ว โมเดลใหญ่กว่าแทบไม่ได้ความแม่นเพิ่ม แต่เสีย RPM ซึ่งเป็นทรัพยากรที่บีบจริงตอนโยนสลิปทีละหลายใบ เลยใช้ flash-lite
